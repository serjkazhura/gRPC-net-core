...
_STATUSMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='succes', full_name='StatusMessage.succes', index=1,
...
_STATUSMESSAGE.fields_by_name['succes'].enum_type = enums__pb2._READINGSTATUS
